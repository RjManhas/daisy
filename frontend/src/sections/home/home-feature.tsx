        ...
        <m.div variants={varFade().inUp} className="space-y-3 text-center">
          <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 dark:bg-gray-100 dark:text-gray-800">
            <m.h2
              ...
              className="mb-8 text-4xl font-bold leading-none text-center"
            >
              What do we have to offer?
            </m.h2>
            <ul className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
              <m.li variants={varFade().inUp} className="flex items-center space-x-2">
                <svg
              ...
              <m.li variants={varFade().inUp} className="flex items-center space-x-2">
                ...
                <span>Incredibly Simple Setup</span>
              </m.li>
              <m.li variants={varFade().inUp} className="flex items-center space-x-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <m.li variants={varFade().inUp} className="flex items-center space-x-2">
                ...
                <span>Endless Customizability </span>
              </m.li>
            </ul>
          </div>
        </m.div>
